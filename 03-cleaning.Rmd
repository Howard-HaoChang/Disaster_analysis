...
#Loading disaster data and map message data
...
disaster_match <- data_remove %>%
  mutate(country.name = ifelse(is.na(countryname(data_remove$Country)),data_remove$Country,countryname(data_remove$Country)))
